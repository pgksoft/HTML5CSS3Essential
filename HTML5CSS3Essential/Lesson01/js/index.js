...
var taskDescriptionImgAdd = document.getElementById('taskDescriptionImgAdd');
...
function SetDescriptionTaskPage(prev) {
    isChecked = true;
    taskDescriptionImgAdd.style.display = "none";
    ...
    switch (prev.id) {
        case "addtask": {
            ...
            taskDescriptionImgAdd.style.display = "block";
            break;
        }
        case "task2": {
        ...
        case "myreseach": {
            linkTaskPage.href = "MyReseach.html";
            break;
        }
        case "myreseach2": {
            linkTaskPage.href = "TabularLayout.html";
            break;
        }
        default: {
            linkTaskPage.href = "#";
