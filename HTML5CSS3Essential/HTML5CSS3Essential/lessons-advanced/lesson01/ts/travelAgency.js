...
class TravelAgency {
    constructor(errorLoadDescription, listAnchorToMap, mapHotel, nameMapHotel, closeMapHotel, mapFrame, sliderHotels) {
...
let manageTavelAgency = new TravelAgency([
    document.getElementById('errorLoadDescription01'),
    document.getElementById('errorLoadDescription02'),
    document.getElementById('errorLoadDescription03'),
    document.getElementById('errorLoadDescription04')
], [
    document.getElementById('01-anchor-to-map'),
    document.getElementById('02-anchor-to-map'),
    document.getElementById('03-anchor-to-map'),
    document.getElementById('04-anchor-to-map')
], document.getElementById('map-hotel'), document.getElementById('map-name-hotel'), document.getElementById('map-close-control'), document.getElementById('map'), [
    new SL.Slider('01', [
    ...
    ], document.getElementById('01-imagesOff'), document.getElementById('01-images-show-left'), document.getElementById('01-images-show-right'), document.getElementById('01-show-collaps-off')),
    new SL.Slider('02', [
    ...
    ], document.getElementById('02-imagesOff'), document.getElementById('02-images-show-left'), document.getElementById('02-images-show-right'), document.getElementById('02-show-collaps-off')),
    new SL.Slider('03', [
    ...
    ], document.getElementById('03-imagesOff'), document.getElementById('03-images-show-left'), document.getElementById('03-images-show-right'), document.getElementById('03-show-collaps-off')),
    new SL.Slider('04', [
    ...
    ], document.getElementById('04-imagesOff'), document.getElementById('04-images-show-left'), document.getElementById('04-images-show-right'), document.getElementById('04-show-collaps-off'))
]);
